...
import { PlusIcon, DocumentTextIcon, UsersIcon, CalendarIcon, ChatBubbleLeftIcon, BoltIcon } from "@heroicons/react/24/outline";
    ...
    <Card>
      <CardContent className="p-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-2">
          ...
          />
          <QuickAction
            icon={<ChatBubbleLeftIcon className="h-5 w-5 text-pink-500" />}
            label="Message"
